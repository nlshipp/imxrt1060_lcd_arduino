...
- {pin_num: F14, pin_signal: GPIO_AD_B0_09, label: 'JTAG_TDI/J21[5]/ENET_RST/J22[5]', identifier: TDI}
...
- pin_list:
  ...
  - {pin_num: J12, peripheral: GPIO1, signal: 'gpio_io, 22', pin_signal: GPIO_AD_B1_06, direction: OUTPUT}
  - {pin_num: H13, peripheral: GPIO1, signal: 'gpio_io, 24', pin_signal: GPIO_AD_B1_08, direction: OUTPUT}
  - {pin_num: L11, peripheral: GPIO1, signal: 'gpio_io, 18', pin_signal: GPIO_AD_B1_02, direction: OUTPUT}
...
void BOARD_InitPins(void) {
  ...
  GPIO_PinInit(GPIO1, 9U, &TDI_config);
  ...
  /* GPIO configuration of SPDIF_OUT on GPIO_AD_B1_02 (pin L11) */
